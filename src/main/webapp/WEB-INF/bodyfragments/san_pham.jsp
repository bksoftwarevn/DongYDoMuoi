        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-5">
                <div class="product-detail_decs">
                    <h1 class="pdc-name">Detox Orgreen</h1>
                    <p class="pdc-price">
                        <del>239.000 ₫</del>
                        <span>167.300 ₫</span>
                    </p>
                    <p class="pdc-pdecs">
                        <strong>Detox Orgreen</strong> là sản phẩm được phân phối độc quyền bởi Công ty CP
                        Nghiên cứu và Ứng dụng
                        Thuốc dân tộc, phù hợp với các trường hợp người bị suy giảm chức năng gan với biểu hiện
                        chán ăn, mệt mỏi, mẩn ngứa, men gan cao. Người sử dụng nhiều rượu bia, tiếp xúc hóa chất
                        có hại cho gan.
                    </p>
                    <p class="pdc-status">
                        <span>Tình trạng:</span>
                        <span id="status-infor-product">Còn hàng</span>
                    </p>
                    <p class="pdc-contact">
                        <span>Gọi đặt mua:</span>
                        <a href="tel:0978960013" class="link-phone-comany text-phone-company">0978960013</a>
                    </p>
                    <p class="pdc-status ">
                        <span>Đơn vị:</span>
                        <span id="don-vi">hộp 10 vỉ, 20 viên/vỉ</span>
                    </p>
                    <div class="pdc-inbut">
                        <div class="bt-gr">
                            <label for="pd-sl">Ngày sử dụng:</label>
                            <input type="number" value="50" min="0" max="100" step="1" id="pd-dt" />
                        </div>
                        <div class="bt-gr">
                            <label for="pd-sl">Số lượng:</label>
                            <input type="number" value="50" min="0" max="100" step="1" id="pd-sl" />
                        </div>
                        <button class="brn btn-primary buynow">Mua ngay</button>
                    </div>
                    <p class="pdc-code">Mã sản phẩm: DETOX-GREEN</p>
