...
<link rel="stylesheet" href="css/cong_trinh.css">


<%--phan chung cho danh muc--%>

<script src="ajax/pages/page_cong_trinh.js"></script>
        ...
        <a href="#" class="tinTuc__element row d-none mt-3 mt-md-5" id="tinTuc__element">
            ...
            <div class="col-12 col-md-7">
                <div class="tinTuc__element--info">
                    <h4 class="tinTuc__element--name text-center text-md-left pt-3 pt-md-0">Đại lý cung
                        cấp bếp điện
...
<%--                    <p class="tinTuc__element--commentCount  text-uppercase">4 comments</p>--%>
                    <div class="tinTuc__element--showMoreBtn d-flex d-md-none d-lg-flex">
